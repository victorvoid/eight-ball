...
public class EightBall extends JComponent implements ActionListener, MouseMotionListener,  KeyListener {
	...
	public static void main (String [] args){
		JFrame window = new JFrame("Eight Ball by Victor");
    ...
    g.fillOval(ballX,ballY,20,20);
		...
		g.drawString("points: "+pontos, 0, 10);
		g.setFont(new Font("Kristen ITC",2, 20));
		g.drawString("Get 8 points ", 300 , 220);
	...
	public void actionPerformed(ActionEvent e){
		...
		if ( ballY >= 590 && pontos != 8 ){
			iniciar = JOptionPane.showConfirmDialog(null, "Do you wanna restart ?"," You lost!", JOptionPane.YES_NO_OPTION);
		...
		//winner
		if(pontos == 8){
        JOptionPane.showMessageDialog(null, "You got "+pontos+"! :)","Congratulations!", JOptionPane.ERROR_MESSAGE);
			System.exit(0);
		}
